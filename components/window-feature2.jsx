...
function WindowFeature2() {
    ...
    return (
        <animated.div ref={ref} className="window-feature-grid">

            <animated.div style={fadeInLeft1} className="window-feature-box window-feature-pic2">
                <img src={pic2} alt="pic2" />
            </animated.div>

            <div className="window-feature-box window-feature-content1">
            ...
            <animated.div style={fadeInLeft2} className="window-feature-box window-feature-pic3">
                <img src={pic3} alt="pic3" />
            </animated.div>

            <div className="window-feature-box window-feature-content2">
            ...
            <animated.div style={fadeInLeft3} className="window-feature-box window-feature-pic1">
                <img src={pic1} alt="pic1" />
            </animated.div>

            <div className="window-feature-box window-feature-content3">
