...
import '../src/assets/css/content-last.css';
import igpic from '../src/assets/img/igpic.png';
import fbpic from '../src/assets/img/fbpic.png';
import logo1 from '../src/assets/img/logo1.jpg';
import logo2 from '../src/assets/img/logo2.jpg';
import logo3 from '../src/assets/img/logo3.jpg';
        ...
        <div className="unique-grid-box">
            ...
            <div className="item-5">
                <div className="social-icons">
                    <img src={fbpic} alt="Facebook" className="social-icon" />
                    <img src={igpic} alt="Instagram" className="social-icon" />
                </div>
            </div>
