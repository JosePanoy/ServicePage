...
import feature1 from '../src/assets/img/feature1.jpeg';
import '../src/assets/css/feature1.css';
...
function Feature1() {
  ...
  return (
    <div className="feature1-container" style={{ backgroundImage: `url(${feature1})` }}>
